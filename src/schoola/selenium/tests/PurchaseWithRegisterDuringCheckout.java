...
public class PurchaseWithRegisterDuringCheckout extends BaseSelenium {
  ...
  public void PuchasewithRegisterDuringCheckout() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		screenshot.takeScreenshot4(driver,"Girls clothes page.png");
		...
		itemclick.clickItem2(driver);
		screenshot.takeScreenshot4(driver,"Item clicked.png");
		...
		screenshot.takeScreenshot4(driver,"Bag.png");
		...
		screenshot.takeScreenshot4(driver,"RegisterDuringCheckout.png");
		...
		screenshot.takeScreenshot4(driver,"Checkout.png");
		...
		screenshot.takeScreenshot4(driver,"OrderSuccessMessage.png");
